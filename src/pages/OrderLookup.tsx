          ...
          <Card className="p-8">
            <form onSubmit={handleLookup} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="orderId">Order ID or Tracking Code</Label>
                <div className="relative">
                  <Input
                    id="orderId"
                    placeholder="e.g., NYM929801CI82MM or your order ID"
                    value={orderId}
                ...
                <p className="text-sm text-muted-foreground">
                  Enter your tracking code (e.g., NYM929801CI82MM) or order ID from your confirmation email
                </p>
              </div>
